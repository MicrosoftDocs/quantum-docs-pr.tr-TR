...
Birden çok kubit de **dolanık hale getirilebilir**. Dolanık bir kubitin ölçümünü yaptığınızda, diğerinin durumuna ilişkin bilginiz de güncelleştirilir.
...
Ayrıca birden çok dolanık kubit uyumlu davrandığında, birden çok seçeneği aynı anda işleyebilir. Dolanık kubitler en hızlı kuantum dışı sistemlerin harcayacağından çok daha kısa sürede bilgileri işleyebilir.
