...
8. xUnit. çözümleyiciler 0.7.0 (https://www.nuget.org/packages/xunit.analyzers/0.7.0)
9. xUnit. soyutlamalar 2.0.1 (https://www.nuget.org/packages/xunit.abstractions/2.0.1)
...
13. FSharp. grafik 0.91.1 (https://www.nuget.org/packages/FSharp.Charting/0.91.1)
...
## <a name="yamldotnetsigned-notices-and-information"></a>YamlDotNet. Imzalı BILDIRIMLER ve BILGILER
---------------------------------------
...
## <a name="xunitrunnervisualstudio-notices-and-information"></a>xUnit. Çalıştırıcısı. VisualStudio BILDIRIMLERI ve BILGILERI
---------------------------------------
Telif hakkı (c) .NET Foundation ve katkıda bulunanlar tüm hakları saklıdır

Apache Lisansı kapsamında lisanslanır, sürüm 2,0 ("Lisans"); Bu dosyayı Lisansla uyumluluk dışında kullanamazsınız.
Lisansın bir kopyasını şurada edinebilirsiniz:

 [http://www.apache.org/licenses/LICENSE-2.0](http://www.apache.org/licenses/LICENSE-2.0)

Yürürlükteki yasalar veya yazma için kabul etmeksizin, lisans altında dağıtılan yazılım, herhangi bir tür GARANTI veya örtük olarak hiçbir GARANTI olmadan "olduğu gıbı" dağıtılır.
Lisans kapsamındaki izinleri ve sınırlamaları yöneten belirli dile yönelik lisansa bakın.



## <a name="xunitrunnerconsole-notices-and-information"></a>xUnit. Çalıştırıcısı. konsol BILDIRIMLERI ve BILGILERI
---------------------------------------
Telif hakkı (c) .NET Foundation ve katkıda bulunanlar tüm hakları saklıdır
...
## <a name="xunitextensibilitycore-notices-and-information"></a>xUnit. Extensibility. Core BILDIRIMLERI ve BILGILERI
---------------------------------------
Telif hakkı (c) .NET Foundation ve katkıda bulunanlar tüm hakları saklıdır
...
## <a name="xunitcore-notices-and-information"></a>xUnit. Core BILDIRIMLERI ve BILGILERI
---------------------------------------
Telif hakkı (c) .NET Foundation ve katkıda bulunanlar tüm hakları saklıdır
...
## <a name="xunitassert-notices-and-information"></a>xUnit. onaylama BILDIRIMLERI ve BILGILERI
---------------------------------------
Telif hakkı (c) .NET Foundation ve katkıda bulunanlar tüm hakları saklıdır
...
## <a name="xunitanalyzers-notices-and-information"></a>xUnit. BILDIRIMLERI ve BILGILERI çözümleyiciler
---------------------------------------
Telif hakkı (c) .NET Foundation ve katkıda bulunanlar tüm hakları saklıdır
...
## <a name="xunitabstractions-notices-and-information"></a>xUnit. soyutlamalar BILDIRIMLERI ve BILGILERI
---------------------------------------
Telif hakkı (c) .NET Foundation ve katkıda bulunanlar tüm hakları saklıdır
...
## <a name="xunit-notices-and-information"></a>xUnit BILDIRIMLERI ve BILGILERI
---------------------------------------
Telif hakkı (c) .NET Foundation ve katkıda bulunanlar tüm hakları saklıdır
...
## <a name="managedesent-notices-and-information"></a>ManagedEsent BILDIRIMLERI ve BILGILERI
---------------------------------------
Microsoft Genel Lisansı (MS-PL)
...
"Katkı", özgün yazılımdır veya yazılımda yapılan herhangi bir ekleme veya değişiklik.

"Katkıda bulunan", katkıyı bu lisans kapsamında dağıtan bir kişidir.

"Lisanslı patentler", katkıda bulunan patent taleplerini doğrudan katkısında okur.
...
(A) ticari marka lisansı yok-bu lisans, hiçbir katkıda bulunan adı, logoyu veya ticari markaları kullanma hakkı vermez.

(B) ihlal edildi, yazılım tarafından talep ettiğiniz patentlere karşı bir patent talebi verirseniz, yazılım için bu katkıda bulunan patent lisanslarınız otomatik olarak sona erer.

(C) yazılımın herhangi bir bölümünü dağıtırsanız, yazılımda bulunan tüm telif hakkı, patent, ticari marka ve atısyon bildirimlerini saklamanız gerekir.
...
## <a name="fsharpcharting-notices-and-information"></a>FSharp. grafik uyarıları ve BILGILERI
---------------------------------------
MıT lisansı (MıT)
...
## <a name="fscheck-notices-and-information"></a>FsCheck BILDIRIMLERI ve BILGILERI
---------------------------------------
...
## <a name="fparsec-notices-and-information"></a>FParsec BILDIRIMLERI ve BILGILERI
---------------------------------------
