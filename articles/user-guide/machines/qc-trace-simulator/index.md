...
|[Temel işlem sayacı](xref:microsoft.quantum.machines.qc-trace-simulator.primitive-counter)  | Kuantum programında çağrılan her işlem tarafından kullanılan temel eleman sayısını verir  |
