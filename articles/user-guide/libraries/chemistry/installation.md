...
Hisse geliştirme seti, NuGet paketi aracılığıyla hisse ve deneme uygulamaları için destek sağlar [`Microsoft.Quantum.Chemistry`](https://www.nuget.org/packages/Microsoft.Quantum.Chemistry) .
...
Bu örnekleri kullanarak yüklemenizi test etmek için, [ana örnekler deposunu](https://github.com/Microsoft/Quantum)kopyalayın ve ardından örneklerden birini çalıştırın.  Örneğin, örneği çalıştırmak için [`MolecularHydrogen`](https://github.com/microsoft/Quantum/tree/master/samples/chemistry/MolecularHydrogen) :
...
Özellikle, paket, `Microsoft.Quantum.Chemistry` en son NWChem sürümleri tarafından dışarı aktarma için desteklenen [Broombridge şeması](xref:microsoft.quantum.libraries.chemistry.schema.broombridge)'nda temsil edilen hisse dili Mistry benzetim sorunlarının örneklerini yüklemeye yönelik araçlar sağlar.
