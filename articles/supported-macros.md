...
<table>
<tr><th>Makro adı</th><th>Sözdizimi</th><th>Sonuçlar</th></tr>
<tr><td>Grup</td><td>\ket{\psı}</td><td>$ \ket{\psı} $</td></tr>
<tr><td>sol</td><td>\bra{\phi}</td><td>$ \bra{\phi} $</td></tr>
<tr><td>braket</td><td>\braket{\phi | \psı}</td><td>$ \braket{\phi | \psı} $</td></tr>
