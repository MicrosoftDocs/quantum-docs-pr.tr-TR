...
Kitaplıkların kaynaklarını ve kod örneklerini GitHub’dan edinebilirsiniz. Daha fazla bilgi için [lisanslama](xref:microsoft.quantum.libraries.licensing) bölümüne bakın. Paket başvurularının (“ikililer”), kitaplıkları projelere eklemeye yönelik farklı bir yol sunan kitaplıklar için de kullanılabilir olduğu unutulmamalıdır. Bunları [NuGet](https://nuget.org) aracılığıyla da kolayca edinebilirsiniz.  