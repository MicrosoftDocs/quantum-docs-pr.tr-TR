...
<span data-ttu-id="16da1-137">Bu komut, [ `Game.qs` dosyadaki `chsh-game` ](https://github.com/microsoft/Quantum/blob/main/samples/algorithms/chsh-game/Game.qs)4 ' e kadar olan satırları, Q# söz dizimi vurgulamanın amacı için kod olarak işaretleyerek, örnekten içeri aktarır.</span><span class="sxs-lookup"><span data-stu-id="16da1-137">This command will import lines 4 to 8 of the [`Game.qs` file from the `chsh-game` sample](https://github.com/microsoft/Quantum/blob/main/samples/algorithms/chsh-game/Game.qs), marking them as Q# code for the purpose of syntax highlighting.</span></span>
