...
Böyle bir değişiklik için bir örnek, Kullanıcı tanımlı uzmanlıkdaki sembol tanımlama grubu ' dir. Önceki sürümlerde denetlenen veya denetlenen-adjoint özelleşme bildirimi tek bir symbol bağımsız değişkeni belirtirken, 0,3 ' den başlayarak, derleyicinin simgeleri çağrılabilir bildirimden, gerekirse, bu tür bir sembol tanımlama grubu olmasını `...`. 
