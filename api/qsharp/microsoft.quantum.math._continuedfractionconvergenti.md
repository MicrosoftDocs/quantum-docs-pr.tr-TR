...
---
# <a name="_continuedfractionconvergenti-function"></a>_ContinuedFractionConvergentI işlevi
...
Bir bağlantılı GCD 'yi hesaplamak için iç özyinelemeli çağrı
...
### <a name="denominatorbound--int"></a>Nominal değeri: [Int](xref:microsoft.quantum.lang-ref.int)





## <a name="output--fraction"></a>Çıkış: [kesir](xref:Microsoft.Quantum.Math.Fraction)
