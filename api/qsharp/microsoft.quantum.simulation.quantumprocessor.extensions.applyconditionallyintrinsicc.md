...
---
# <a name="applyconditionallyintrinsicc-operation"></a>ApplyConditionallyIntrinsicC işlemi
...
### <a name="onequalop--unit--unit-ctl"></a>onequalop: [birim](xref:microsoft.quantum.lang-ref.unit) => [birim](xref:microsoft.quantum.lang-ref.unit) CTL




### <a name="onnonequalop--unit--unit-ctl"></a>onnonequalop: [birim](xref:microsoft.quantum.lang-ref.unit) => [birim](xref:microsoft.quantum.lang-ref.unit) CTL
