...
ms.locfileid: "96195894"
---
# <a name="accumulatedbitsizei-function"></a>AccumulatedBitsizeI işlevi
...
Bir değerin bit boyutunu yinelemeli olarak hesaplamak için kullanılan yardımcı işlev.
...
### <a name="bitsize--int"></a>bit boyutu: [Int](xref:microsoft.quantum.lang-ref.int)
