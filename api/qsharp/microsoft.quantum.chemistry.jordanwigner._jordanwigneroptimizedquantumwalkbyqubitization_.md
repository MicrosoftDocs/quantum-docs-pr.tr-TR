...
---
# <a name="_jordanwigneroptimizedquantumwalkbyqubitization_-function"></a>_JordanWignerOptimizedQuantumWalkByQubitization_ işlevi
...
## <a name="output--intintdoublequbitqubit--unit--is-adj--ctl"></a>Çıkış: (([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)), ([Double](xref:microsoft.quantum.lang-ref.double), ([qubit](xref:microsoft.quantum.lang-ref.qubit)[],[qubit](xref:microsoft.quantum.lang-ref.qubit)[]) => [birimi](xref:microsoft.quantum.lang-ref.unit)  ayarlama ve CTL))
