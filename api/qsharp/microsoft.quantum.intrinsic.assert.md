...
ms.locfileid: "92726720"
---
# <a name="assert-operation"></a>Onaylama işlemi
...
> [!WARNING]
> Onaylama kullanım dışı bırakıldı. Lütfen <xref:Microsoft.Quantum.Diagnostics.AssertMeasurement> bunun yerine kullanın.
