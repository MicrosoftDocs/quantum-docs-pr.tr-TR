...
### <a name="onequalop--t--unit-ctl--adj"></a>onEqualOp: 'T => [Unit](xref:microsoft.quantum.lang-ref.unit) CTL + ayarlanabilir
...
### <a name="onnonequalop--u--unit-ctl--adj"></a>onNonEqualOp: ' U => [birim](xref:microsoft.quantum.lang-ref.unit) CTL + ayarlanabilir
