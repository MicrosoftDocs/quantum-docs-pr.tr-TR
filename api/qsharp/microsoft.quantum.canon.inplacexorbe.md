...
ms.locfileid: "92728669"
---
# <a name="inplacexorbe-operation"></a>Inplacexorbe işlemi
...
> [!WARNING]
> Inplacexorbe kullanım dışı bırakıldı. Lütfen <xref:ApplyReversedOpLECA(ApplyXorInPlace(value, _), target)> bunun yerine kullanın.
>
> Bu işlem kaldırılmıştır.
...
### <a name="target--bigendian"></a>Hedef: [Bigenyen](xref:Microsoft.Quantum.Arithmetic.BigEndian)
