...
ms.locfileid: "92727938"
---
# <a name="_optimizedqubitizationoracleseperatedregisters_-function"></a>_Optimizedqubitişzationoracleayrılmış Yazmaçları_ işlevi
...
## <a name="output--intintdoublequbitqubit--unit-adj--ctl"></a>Çıkış: (([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)), ([Double](xref:microsoft.quantum.lang-ref.double), ([qubit](xref:microsoft.quantum.lang-ref.qubit)[],[qubit](xref:microsoft.quantum.lang-ref.qubit)[]) => [Unit](xref:microsoft.quantum.lang-ref.unit) ayarlaması + CTL))
