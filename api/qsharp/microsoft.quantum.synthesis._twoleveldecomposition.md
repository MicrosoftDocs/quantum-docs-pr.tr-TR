...
---
# <a name="_twoleveldecomposition-function"></a>_TwoLevelDecomposition işlevi
...
## <a name="output--complexintint"></a>Çıkış: ([Complex](xref:Microsoft.Quantum.Math.Complex)[] [],[int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)) []
