...
title: GetGeneratorSystemNTerms işlevi
...
ms.locfileid: "92733530"
---
# <a name="getgeneratorsystemnterms-function"></a>GetGeneratorSystemNTerms işlevi
...
İçindeki koşulların sayısını alır `GeneratorSystem` .
...
İçindeki koşulların sayısı `GeneratorSystem` .
