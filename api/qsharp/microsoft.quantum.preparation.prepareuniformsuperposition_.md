...
---
# <a name="prepareuniformsuperposition_-operation"></a>PrepareUniformSuperposition_ işlemi
...
Uygulama adımı <xref:microsoft.quantum.canon.prepareuniformsuperposition>
...
### <a name="idxflag--int"></a>ıdxflag: [Int](xref:microsoft.quantum.lang-ref.int)
