...
---
# <a name="_quantumromdiscretization-function"></a>_QuantumROMDiscretization işlevi
...
## <a name="output--doubleintint"></a>Çıkış: ([Double](xref:microsoft.quantum.lang-ref.double),[int](xref:microsoft.quantum.lang-ref.int)[],[int](xref:microsoft.quantum.lang-ref.int)[])
