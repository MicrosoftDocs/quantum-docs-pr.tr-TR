...
ms.locfileid: "92726095"
---
# <a name="signb-function"></a>SignB işlevi
...
> [!WARNING]
> SignB kullanım dışı bırakıldı. Lütfen <xref:Microsoft.Quantum.Math.SignL> bunun yerine kullanın.
>
> Lütfen @"microsoft.quantum.math.signl" kullanın.
