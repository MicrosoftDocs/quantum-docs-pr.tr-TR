...
---
# <a name="ampampphasesfixedpoint-function"></a>AmpAmpPhasesFixedPoint işlevi
...
> [!WARNING]
> AmpAmpPhasesFixedPoint kullanım dışı bırakıldı. Lütfen <xref:Microsoft.Quantum.AmplitudeAmplification.FixedPointReflectionPhases> bunun yerine kullanın.
>
> Lütfen @"microsoft.quantum.amplitudeamplification.fixedpointreflectionphases" kullanın.
