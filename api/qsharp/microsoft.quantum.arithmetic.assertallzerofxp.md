...
ms.locfileid: "92731695"
---
# <a name="assertallzerofxp-operation"></a>AssertAllZeroFxP işlemi
...
Bir hisse sabit noktalı sayının sıfıra başlatıldığını ve yani tüm qubits 'in $ \gre$ durumunda olduğunu onaylama için yardımcı işlev {0} .
