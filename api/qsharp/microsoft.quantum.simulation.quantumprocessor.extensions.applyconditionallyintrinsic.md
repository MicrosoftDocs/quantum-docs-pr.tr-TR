...
ms.locfileid: "98858482"
---
# <a name="applyconditionallyintrinsic-operation"></a>ApplyConditionallyIntrinsic işlemi
...
### <a name="onequalop--unit--unit"></a>onequalop: [birim](xref:microsoft.quantum.lang-ref.unit) => [birim](xref:microsoft.quantum.lang-ref.unit) 




### <a name="onnonequalop--unit--unit"></a>onnonequalop: [birim](xref:microsoft.quantum.lang-ref.unit) => [birim](xref:microsoft.quantum.lang-ref.unit) 
