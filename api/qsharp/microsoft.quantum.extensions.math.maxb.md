...
ms.locfileid: "98849701"
---
# <a name="maxb-function"></a>MaxB işlevi
...
> [!WARNING]
> MaxB kullanım dışı bırakıldı. Lütfen <xref:Microsoft.Quantum.Math.MaxL> bunun yerine kullanın.
>
> Lütfen @"microsoft.quantum.math.maxl" kullanın.
