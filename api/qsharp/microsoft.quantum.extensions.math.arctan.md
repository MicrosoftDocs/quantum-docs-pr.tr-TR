...
ms.locfileid: "92726239"
---
# <a name="arctan-function"></a>ArcTan işlevi
...
> [!WARNING]
> ArcTan kullanım dışı bırakıldı. Lütfen <xref:Microsoft.Quantum.Math.ArcTan> bunun yerine kullanın.
>
> Lütfen @"microsoft.quantum.math.arctan" kullanın.
