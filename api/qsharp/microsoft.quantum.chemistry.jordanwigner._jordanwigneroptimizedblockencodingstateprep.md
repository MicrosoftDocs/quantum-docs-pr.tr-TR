...
---
# <a name="_jordanwigneroptimizedblockencodingstateprep-operation"></a>_JordanWignerOptimizedBlockEncodingStatePrep işlemi
...
### <a name="qromidxregister--littleendian"></a>Qromıdxregister: [Litttaendian](xref:Microsoft.Quantum.Arithmetic.LittleEndian)
...
### <a name="selectzcontrolregisters--qubit"></a>Selectzcontrolyazmaçları: [qubit](xref:microsoft.quantum.lang-ref.qubit)[]




### <a name="optimizedbecontrolregisters--qubit"></a>Optimizedbecontrolyazmaçları: [qubit](xref:microsoft.quantum.lang-ref.qubit)[]




### <a name="paulibases--qubit"></a>Pauliesalar: [qubit](xref:microsoft.quantum.lang-ref.qubit)[]




### <a name="paulibasesidx--littleendian"></a>Paulibasesıdx: [Litttaendian](xref:Microsoft.Quantum.Arithmetic.LittleEndian)




### <a name="indexregisters--littleendian"></a>ındexyazmaçları: [Littliendian](xref:Microsoft.Quantum.Arithmetic.LittleEndian)[]
