...
> [!WARNING]
> AssertQubit kullanım dışı bırakıldı. Lütfen <xref:Microsoft.Quantum.Diagnostics.AssertQubit> bunun yerine kullanın.
>
> Lütfen @"microsoft.quantum.diagnostics.assertqubit" kullanın.
